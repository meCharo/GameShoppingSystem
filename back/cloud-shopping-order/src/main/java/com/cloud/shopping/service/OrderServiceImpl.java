...
import com.cloud.shopping.entity.OrderDTO;
import com.cloud.shopping.entity.OrderItemDTO;
import com.cloud.shopping.entity.Code;
import com.cloud.shopping.entity.Game;
import com.cloud.shopping.mapper.CodeMapper;
import com.cloud.shopping.mapper.OrderMapper;
import com.cloud.shopping.mapper.OrdermapperMapper;
import com.cloud.shopping.mapper.OrderitemMapper;
import com.cloud.shopping.utils.MsgCenter;
import com.cloud.shopping.utils.PageUtil;
import com.cloud.shopping.utils.Result;
import com.cloud.shopping.client.GameMapperClient;
...
//    private GameMapper gameMapper;
    // TODO how to use
    @Autowired
    private GameMapperClient gameMapper;
    @Autowired
    private OrdermapperMapper ordermapperMapper;
    @Autowired
    private CodeMapper codeMapper;

    public Result demo(int orderId){
...
//        System.out.println(gameMapper.selectById(gids.get(0)));
        // 对所有的游戏进行存储、计价
