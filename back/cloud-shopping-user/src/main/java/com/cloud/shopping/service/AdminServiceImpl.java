...
public class AdminServiceImpl implements AdminService {
    ...
    @Autowired
    private KindMapperClient kindMapper;
    @Autowired
    private KindmapperMapperClient kindmapperMapper;
    @Autowired
    private TagMapperClient tagMapper;
    @Autowired
    private TagmapperMapperClient tagmapperMapper;
    @Autowired
    private ImgMapperClient imgMapper;
    @Autowired
