                                ...
                                <div class="row">
                                    <p class="text-right" style="padding-top:30px;padding-right:30px"
                                       id="shopingcartbtn"><a href="#" class="btn btn-info btn-lg"
                                            ...
                                            class="glyphicon glyphicon-shopping-cart"></span>Add to shopping cart </a></p>
                                </div>
                            </div>
                        </div>
                        <div class="row"> &nbsp;</div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <table class="table table-hover">
                            <h4 style="color:#4582A5">MINIMUM</h4>
                            <tbody id="systemcfg">
                    ...
                    <div class="col-md-4 col-md-offset-2" style=" padding-left:0px; padding-right:0px">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <tr>
                                <td align="center" style="color:#acb2b8">Chinese</td>
                                <td align="center" style="color:gray"></td>
                                <td align="center" style="color:gray">Not support</td>
                                <td align="center" style="color:gray"></td>
                            </tr>
                            <tr>
