item active<%@ page contentType="text/html;charset=UTF-8" language="java" isELIgnored="false" %>
...
<%--                <div class="tit tit_0"> 精 选 和 推 荐</div>--%>
            ...
            <div class="row">
                <div class="tit tit_1"> Relax Games</div>
            </div>
            ...
            <div class="row zx">
                <div class="col-md-8">
                    <ul id="myTab" class="nav nav-tabs">
                        <li role="presentation"><a href="#home" data-toggle="tab">New & Trending</a></li>
<%--                        <li role="presentation"><a href="#home" data-toggle="tab">新品与热门商品</a></li>--%>
                        <li role="presentation"><a href="#jijiang" data-toggle="tab">Popular Upcoming</a></li>
