...
$(
    function () {
        ...
        $.post(url, function (result) {
                ...
                time.className = "row";
                time.innerHTML = "<p><h6 style='color:white'>Issuing Date：" + utime + "<h6></p><p><h6 style='color:white'>Developers：" + result.data.creater + "<h6></p><p> <h6 style='color:gray'>Customized Tags：</h6><div class='btn-group btn-group-xs' id='tags'></div> </h6></p>";
                ...
                if (result.data.stat == '1') {
                    spc.innerHTML = "<h2>Buy " + result.data.name + ": ¥" + result.data.price + "</h2>";
                    shoppingcar.appendChild(spc);
                } else {
                    if (result.data.stat == '0') {
                        stat = "Product Listing"
                ...
                if (result.data.tags) {
                    ...
                    while (result.data.tags[j]) {
                        ...
                        ll.innerHTML = "<a href='/api/game/tag/" + tid + "/games" + "'><span class='tags'>" + result.data.tags[j].name + "</span></a>";
                        tt.appendChild(ll);
                        j++;
                    }
                }
